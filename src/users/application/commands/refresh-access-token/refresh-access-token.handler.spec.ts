  ...
  describe('application', () => {
    describe('commands', () => {
      describe('refresh-access-token', () => {
        test('should throw UnauthorizedException because RefreshToken to use was not found', () => {
          // Arrange
          ...
          const command = mocked<RefreshAccessTokenCommand>({
            refreshTokenToUse: 'refresh-token-to-use',
            ipAddress: '192.168.1.1',
          } as unknown as RefreshAccessTokenCommand);
        ...
        test('should throw UnauthorizedException because the RefreshToken User was not found', () => {
          // Arrange
          const unitOfWork = mocked<UnitOfWork>({} as unknown as UnitOfWork);
        ...
        test('should throw UnauthorizedException because the RefreshToken to use is expired', () => {
          // Arrange
          const unitOfWork = mocked<UnitOfWork>({} as unknown as UnitOfWork);
        ...
        test('should throw UnauthorizedException because the RefreshToken to use is revoked', async () => {
          // Arrange
        ...
        test('should throw UnauthorizedException because the RefreshToken to use was previously used', async () => {
          // Arrange
          const unitOfWork = mocked<UnitOfWork>({
            commitChanges: jest.fn(),
          } as unknown as UnitOfWork);
        ...
        test('should generate the auth tokens using the refresh token', async () => {
          // Arrange
          const unitOfWork = mocked<UnitOfWork>({
            commitChanges: jest.fn(),
          } as unknown as UnitOfWork);
